...
class ProductCardInventory(QWidget):
    def __init__(self, product:ProductItem):
        ...
        self.container.setStyleSheet("background-color: " + Theme.GHOST_WHITE + "; border-radius: 30; color: " + Theme.DARK_BLUE + ";")
        ...
        self.product_name_label.setText("Product Name: "+ str(product.get_name()))
        ...
        self.weight_label.setText("Weight: "+ str(product.get_weight()) +" kg")

        self.low_stock_level_label = QLabel(self)
        self.low_stock_level_label.setFont(Theme.POPPINS_REGULAR_18)
        self.low_stock_level_label.setText("Low stock level: " + str(product.get_low_stock_quantity()))
