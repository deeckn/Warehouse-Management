...
from PySide6.QtWidgets import (QLabel, QWidget,QSpacerItem,QSizePolicy, QVBoxLayout ,QHBoxLayout, QStackedWidget)
from PySide6.QtCore import (Qt)

from items.sideMenuItem import Side_Menu_Item
...
class Base_View(QWidget):
    def __init__(self) -> None:
        ...
        self.bt_bar_spacer = QSpacerItem(0, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)
        ...
        self.logout_bt = Side_Menu_Item("out","Log out")
    ...
    def add_side_menu_bt(self, bt_img:str, bt_text:str):
        new_bt = Side_Menu_Item(bt_img,bt_text)
        new_bt.set_click()
        self.count_bt += 1
