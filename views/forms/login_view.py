...
class LoginView(QWidget):
    def __init__(self):
        ...
        self.page_label.setStyleSheet(
            u"background-color: #F8F8FF;border-radius: 50;")
        ...
        self.login_label.setStyleSheet(
            u"background-color: #F8F8FF;color: #1A374D;")
        ...
        self.username_label.setStyleSheet(
            u"background-color: #F8F8FF; color: #406882;")
        ...
        self.error_label.setStyleSheet(
            u"background-color: #F8F8FF; color: Red;")
